...
import com.gerald.arcanechunkloaders.block.KineticAnchorBlock;
...
public final class AnchorRegistries {
    ...
    static {
        for (AnchorVariant variant : AnchorVariant.values()) {
            ...
            ITEMS.register(variant.id(), () -> new com.gerald.arcanechunkloaders.item.AnchorBlockItem(block.get(), variant, new Item.Properties()));
        }
    }
